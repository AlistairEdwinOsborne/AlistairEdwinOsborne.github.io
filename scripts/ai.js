...
var AI = function(level) {
   ...
   /*
     * private function: make the ai player take a M.E.N.A.C.E move
    ...
    function takeMenaceMove(turn){
       ...
       /* All rotation and reflection functions performed upon the current state of the board to be
        * compared later on with in the function
   ...
   /*
     * private function: place the X or O on the board in a position once a board place has been passed
     * and highlights the relevant bead after rotation
     * @param boardPlace [int]: Place in which to put the X or O in the board
     */      
...
function makeMenaceMove(boardPlace){
   ...
   /*
     * private function: generate a place on the board for M.E.N.A.C.E to place its X or O if there
     * is no available moves to make i.e. the cumulativeProbability is 0
     */ 
function makeRandomMove(){
 ...
 /*
     * private function: generates the probability for the current board state within the bead array
     */ 
...
*/
		...
		//rotation courtesy of Patricia Shaw "Learning Winning Strategies in Games" 200/5 Chapter 3 Page 17-10
    };
